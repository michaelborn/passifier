component accessors="true" {
    property name="OnlineThrottling100perHour" type="numeric" setter="false";
    property name="OnlineNoThrottling10perSecond" type="numeric" setter="false";
    property name="OfflineSlowHashing1e4perSecond" type="numeric" setter="false";
    property name="OfflineFastHashing1e10PerSecond" type="numeric" setter="false";
